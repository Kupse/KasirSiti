	...
	<div class="card-body">
							...
							<tr>
								...
								<td>
									<form method="post" action="hitung_subtotal.php">
										<?php 
											...
											?>
									<div class="form-group">
										<input type="text" name="JumlahProduk" value="<?php echo $d_detailpenjualan['JumlahProduk']; ?>">
									</div>
								</td>
								...
								<td>
									...
									<form method="post" action="hapus_detail_pembelian.php">
										<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
										<input type="text" name="DetailID" value="<?php echo $d_detailpenjualan['DetailID']; ?>" hidden>
										<button type="submit" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i> Hapus</button>
									</form>
								</td>
							</tr>
						<?php } else {
		...
		<br>
			<form method="post" action="simpan_total_harga.php">
				...
				<div class="col-sm-2">
					<div class="form-group">
						<button class="btn btn-info btn-sm form-control" type="submit"><i class="fas fa-save"></i> Simpan</button>
					</div>
				</div>
			</div>
			</form>
